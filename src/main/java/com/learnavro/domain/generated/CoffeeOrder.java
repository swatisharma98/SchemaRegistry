...
static {
   ...
   */
  public CoffeeOrder(java.lang.Integer id, java.lang.CharSequence name, java.lang.CharSequence nickName, com.learnavro.domain.generated.Store store, java.util.List<com.learnavro.domain.generated.OrderLineItem> orderLineItems, java.time.Instant orderTime, java.lang.CharSequence status) {
    this.id = id;
    this.name = name;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: orderTime = (java.time.Instant)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CoffeeOrder>
    ...
    private Builder(com.learnavro.domain.generated.CoffeeOrder.Builder other) {
      ...
      if (isValidValue(fields()[5], other.orderTime)) {
        this.orderTime = data().deepCopy(fields()[5].schema(), other.orderTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learnavro.domain.generated.CoffeeOrder.Builder setOrderTime(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learnavro.domain.generated.CoffeeOrder.Builder clearOrderTime() {
    ...
    public CoffeeOrder build() {
      try {
        ...
        record.orderTime = fieldSetFlags()[5] ? this.orderTime : (java.time.Instant) defaultValue(fields()[5]);
